      ...
      subs: [
        {
          ...
          items: [
            ...
            { label: "블라우스/셔츠", keyword: "여성 블라우스 셔츠" },
            { label: "니트/가디건", keyword: "여성 니트 가디건" },
            { label: "자켓/코트", keyword: "여성 자켓 코트" },
            { label: "바지/슬랙스", keyword: "여성 바지 슬랙스" },
            { label: "스커트/치마", keyword: "여성 치마 스커트" },
            { label: "레깅스", keyword: "여성 레깅스" },
            { label: "트레이닝복/홈웨어", keyword: "여성 트레이닝복 잠옷" },
          ],
        },
        {
          label: "남성패션",
          items: [
            ...
            { label: "셔츠/남방", keyword: "남성 셔츠 남방" },
            { label: "니트/가디건", keyword: "남성 니트 가디건" },
            { label: "자켓/점퍼", keyword: "남성 자켓 점퍼" },
            { label: "바지/슬랙스", keyword: "남성 바지 슬랙스" },
        ...
        },
        {
          ...
          items: [
            ...
            { label: "스커너즈/슬립온", keyword: "스니커즈 슬립온" },
            { label: "슬리퍼/샌들", keyword: "슬리퍼 샌들" },
            { label: "가방/백팩", keyword: "여성 남성 가방 백팩" },
            { label: "지갑/벨트", keyword: "지갑 벨트" },
            { label: "모자", keyword: "볼캡 버킷햇" },
            { label: "양말/스타킹", keyword: "패션 양말 스타킹" },
          ],
        },
      ],
    },
      ...
      subs: [
        {
          label: "기초케어",
          items: [
            { label: "스킨/토너", keyword: "스킨 토너" },
            { label: "에센스/세럼", keyword: "에센스 세럼 앰플" },
            { label: "로션/크림", keyword: "로션 수분크림" },
        ...
        },
        {
          label: "포인트메이크업",
          items: [
            { label: "베이스/쿠션", keyword: "메이크업 베이스 쿠션" },
            { label: "립/틴트", keyword: "립스틱 틴트 립밤" },
            { label: "아이 브로우", keyword: "아이브로우" },
            { label: "아이섀도우", keyword: "아이섀도우" },
            { label: "마스카라/라이너", keyword: "마스카라 아이라이너" },
          ],
        },
        {
          label: "헤어/바디",
          items: [
            ...
            { label: "바디워시/로션", keyword: "바디워시 바디로션" },
        ...
        },
        {
          ...
          items: [
            ...
            { label: "오메가3/루테인", keyword: "오메가3 루테인" },
            { label: "다이어트식품", keyword: "다이어트 보조제 쉐이크" },
            { label: "홍삼/인삼", keyword: "홍삼 정보" },
          ],
        },
      ],
    },
      ...
      subs: [
        {
          label: "주방도구",
          items: [
            { label: "냄비/찜기", keyword: "인덕션 냄비" },
            { label: "프라이팬", keyword: "코팅 프라이팬" },
            { label: "칼/도마", keyword: "주방칼 도마" },
            { label: "조리도구", keyword: "실리콘 조리도구" },
            { label: "식기/그릇", keyword: "그릇 홈세트" },
            { label: "컵/텀블러", keyword: "컵 텀블러" },
          ],
        },
        {
          label: "욕실용품",
          items: [
            { label: "샤워기/수전", keyword: "필터 샤워기" },
            { label: "욕실매트", keyword: "규조토 매트" },
            { label: "욕실수납", keyword: "욕실 선반" },
            { label: "치약/칫솔", keyword: "치약 칫솔" },
          ],
        },
        {
          label: "청소/세탁",
          items: [
            { label: "세제/유연제", keyword: "세탁 세제 유연제" },
            { label: "청소도구/밀대", keyword: "밀대 걸레" },
            { label: "쓰레기통", keyword: "기저귀 쓰레기통" },
            { label: "옷걸이/건조대", keyword: "논슬립 옷걸이 건조대" },
          ],
        },
      ],
    },
      ...
      subs: [
        {
          ...
          items: [
            ...
            { label: "전기방석/매트", keyword: "전기 매트 방석" },
          ],
        },
        {
          label: "주방가전",
          items: [
            ...
            { label: "커피머신/포트", keyword: "커피 머신 전기포트" },
            { label: "믹서/블렌더", keyword: "믹서기 블렌더" },
            { label: "와플/샌드위치", keyword: "와플 메이커" },
          ],
        },
        {
          label: "컴퓨터/모바일",
          items: [
            { label: "마우스/키보드", keyword: "무선 마우스 키보드" },
            { label: "보조배터리", keyword: "보조배터리" },
            { label: "케이블/충전기", keyword: "PD 충전기 케이블" },
            { label: "휴대폰케이스", keyword: "폰 케이스" },
          ],
        },
      ],
    },
      ...
      subs: [
        {
          label: "침구/커튼",
          items: [
            { label: "베개/바디필로우", keyword: "경추 베개" },
            { label: "이불/침구", keyword: "차렵 이불 세트" },
            { label: "커튼/블라인드", keyword: "암막 커튼 블라인드" },
            { label: "러그/카페트", keyword: "러그 카페트" },
          ],
        },
        {
          label: "가구/수납",
          items: [
            { label: "의자/책상", keyword: "컴퓨터 의자 책상" },
            { label: "선반/행거", keyword: "철제 선반 행거" },
            { label: "수납함/박스", keyword: "리빙박스 수납박스" },
            { label: "조명/스탠드", keyword: "단스탠드 무드등" },
          ],
        },
      ],
    },
      ...
      subs: [
        {
          label: "캠핑용품",
          items: [
            { label: "텐트/타프", keyword: "캠핑 텐트 타프" },
            { label: "캠핑의자/테이블", keyword: "캠핑 의자 테이블" },
            { label: "랜턴/조명", keyword: "캠핑 랜턴" },
            { label: "침낭/매트", keyword: "캠핑 침낭 매트" },
            { label: "화로대/소품", keyword: "캠핑 화로대" },
          ],
        },
        {
          label: "헬스/요가",
          items: [
            { label: "요가매트/소도구", keyword: "요가매트 폼롤러" },
            { label: "아령/웨이트", keyword: "덤벨 아령" },
            { label: "운동복/레깅스", keyword: "스포츠 운동복 레깅스" },
          ],
        },
      ],
    },
      ...
      subs: [
        {
          label: "반려동물",
          items: [
            { label: "강아지간식/사료", keyword: "강아지 사료 간식" },
            { label: "고양이간식/사료", keyword: "고양이 사료 간식" },
            { label: "배변패드/모래", keyword: "배변패드 고양이모래" },
            { label: "용품/장난감", keyword: "반려동물 장난감" },
          ],
        },
        {
          label: "자동차용품",
          items: [
            { label: "방향제/디퓨저", keyword: "차량용 방향제" },
            { label: "거치대/충전기", keyword: "차량용 거치대" },
            { label: "세차용품", keyword: "세차 타월 왁스" },
            { label: "차량용 청소기", keyword: "차량용 무선 청소기" },
            { label: "블랙박스/기타", keyword: "차량용 블랙박스 거치대" },
          ],
        },
      ],
    },
      ...
      subs: [
        {
          ...
          items: [
            ...
            { label: "인스턴트커피", keyword: "스틱커피" },
            { label: "녹차/홍차", keyword: "녹차 홍차" },
            { label: "허브차", keyword: "허브차" },
            { label: "과일주스", keyword: "과일주스" },
          ],
        },
        {
          label: "간식/디저트",
          items: [
            { label: "스낵/봉지과자", keyword: "봉지과자" },
            { label: "초콜릿", keyword: "초콜릿" },
            { label: "캔디/사탕", keyword: "사탕" },
            { label: "견과류", keyword: "견과류" },
            { label: "건과일", keyword: "건과일" },
            { label: "젤리", keyword: "젤리" },
            { label: "껌", keyword: "껌" },
          ],
        },
        {
          ...
          items: [
            ...
            { label: "프로폴리스", keyword: "프로폴리스" },
            { label: "벌꿀", keyword: "천연 벌꿀" },
            { label: "다이어트 쉐이크", keyword: "다이어트 쉐이크" },
            { label: "단백질 보충제", keyword: "단백질 보충제" },
            { label: "식용유/오일", keyword: "식용유 올리브유" },
            { label: "양념/소스", keyword: "간장 고추장 드레싱" },
          ],
        },
      ],
    },
      ...
      subs: [
        {
          label: "문구/사무",
          items: [
            { label: "필기구", keyword: "볼펜 샤프 마카" },
            { label: "노트/수첩", keyword: "다이어리 노트" },
            { label: "사무용품", keyword: "계산기 스테이플러 클립" },
          ],
        },
        {
          label: "취미/미술",
          items: [
            { label: "화방용품", keyword: "물감 붓 스케치북" },
            { label: "DIY/공예", keyword: "비즈공예 프라모델 퍼즐" },
            { label: "서적/교육", keyword: "문제집 실용서" },
          ],
        },
        {
          label: "악기",
          items: [
            { label: "기타/우쿨렐레", keyword: "통기타 우쿨렐레" },
            { label: "디지털 피아노", keyword: "전자 피아노 건반" },
            { label: "칼림바/기타", keyword: "칼림바 하모니카" },
          ],
        },
      ],
    },
